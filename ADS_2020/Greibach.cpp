...
namespace GRB
{
	Greibach greibach(NS('S'), TS('$'), 8,
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 2, 14,  //function body
			...
			Rule::Chain(9, TS('w'), TS('('), NS('V'), NS('С'), NS('V'), TS(')'), TS('['), NS('N'), TS(']')),
			Rule::Chain(10, TS('w'), TS('('), NS('V'), NS('C'), NS('V'), TS(')'), TS('['), NS('N'), TS(']'), NS('N')),

			Rule::Chain(3, TS('o'), NS('E'), TS(';'))
		),
		Rule(NS('E'), GRB_ERROR_SERIES + 3, 17, //expressions
			Rule::Chain(1, TS('i')),
		...
		Rule(NS('M'), GRB_ERROR_SERIES + 5, //arithmetic signs
			20,
